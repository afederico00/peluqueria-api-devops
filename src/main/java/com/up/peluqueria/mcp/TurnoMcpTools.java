...
public class TurnoMcpTools {
    ...
    @McpTool(
            description =
                    "Crea un turno para un peluquero. Solo se aceptan turnos de martes a sábado, entre 09:00 y 17:30, en punto o y media, y no puede haber dos turnos RESERVADO para el mismo peluquero, fecha y hora.")
    public TurnoResponseDTO crear_turno(
            ...
            @McpToolParam(description = "Estado del turno, por ejemplo RESERVADO o FINALIZADO.", required = true)
                    String estadoTurno,
            @McpToolParam(description = "ID del peluquero al que se asigna el turno.", required = true)
                    Long peluqueroId) {
    ...
    @McpTool(
            description =
                    "Actualiza un turno existente. Solo se aceptan turnos de martes a sábado, entre 09:00 y 17:30, en punto o y media, y no puede haber dos turnos RESERVADO para el mismo peluquero, fecha y hora.")
