...
@Tag(
        name = "Turnos",
        description = "Operaciones sobre turnos. Un turno en estado RESERVADO indica un "
...
public class TurnoController {
    ...
    @ApiResponses({
        ...
        @ApiResponse(
                responseCode = "400",
                description = "Datos inválidos o conflicto de reserva",
                content =
                        @Content(
                                ...
                                examples = {
                                    ...
                                    @ExampleObject(
                                            name = "diaSemana",
                                            value =
                                                    "{\"message\": \"Solo se pueden reservar turnos de martes a sábado\"}"),
                                    @ExampleObject(
                                            name = "minutosInvalidos",
                                            value =
                                                    "{\"message\": \"Los turnos solo pueden reservarse en punto o y media (ej: 12:00 o 12:30)\"}"),
                                    @ExampleObject(
                                            name = "rangoHorario",
                                            value =
                                                    "{\"message\": \"Los turnos solo pueden reservarse de 09:00 a 17:30\"}"),
                                    @ExampleObject(
                                            name = "estadoInvalido",
                                            value =
                                                    "{\"message\": \"El estadoTurno debe ser uno de: RESERVADO, FINALIZADO\"}"),
                                    @ExampleObject(
                                            name = "turnoOcupado",
                                            value =
                                                    "{\"message\": \"El peluquero ya tiene un turno RESERVADO el 2025-06-17 a las 10:30\"}")
                                })),
        @ApiResponse(
                responseCode = "404",
    ...
    public ResponseEntity<TurnoResponseDTO> crear(@Valid @RequestBody TurnoRequestDTO turnoRequestDTO) {
        log.info(
                "Recibida la peticion para registrar turno para el peluquero con ID: {}",
    ...
    @ApiResponses({
        ...
        @ApiResponse(
                responseCode = "404",
                description = "Turno o peluquero no encontrado",
                content =
                        @Content(
                                schema = @Schema(implementation = ErrorResponse.class),
                                examples = {
                                    @ExampleObject(
                                            name = "turnoNoEncontrado",
                                            value = "{\"message\": \"Turno con id 99 no encontrado\"}"),
                                    @ExampleObject(
                                            name = "peluqueroNoEncontrado",
