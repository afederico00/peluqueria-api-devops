...
public class PeluqueroController {
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Lista de peluqueros obtenida exitosamente",
    ...
    @GetMapping("/{id}")
    @Operation(
            summary = "Obtener un peluquero por ID",
    ...
    @PostMapping
    @Operation(
            summary = "Crear un nuevo peluquero",
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "201",
                description = "Peluquero creado exitosamente",
                content = @Content(schema = @Schema(implementation = PeluqueroResponseDTO.class))),
        @ApiResponse(
                responseCode = "400",
    ...
    public ResponseEntity<PeluqueroResponseDTO> crear(@Valid @RequestBody PeluqueroRequestDTO peluqueroRequestDTO) {
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Peluquero actualizado exitosamente",
                content = @Content(schema = @Schema(implementation = PeluqueroResponseDTO.class))),
        @ApiResponse(
                responseCode = "400",
    ...
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
                description = "Peluquero eliminado exitosamente",
        ...
        @ApiResponse(
                responseCode = "409",
                description = "El peluquero tiene turnos asociados y no se confirmó la eliminación",
                content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
        @ApiResponse(
                responseCode = "500",
                description = "Error interno del servidor",
